...
To demonstrate the  proposed optimization framework, we use the following variables (in Fig. \ref{fig:sys}) in the VSG controlled grid-forming converters (GFM):
\begin{eqnarray}
